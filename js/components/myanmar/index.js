...
class Myanmar extends Component {  // eslint-disable-line
  ...
  constructor(props) {
    ...
    this.state = {
      laws:data.mmlaws.sort(function (a, b) {
                return parseInt(a.order) - parseInt(b.order);;
            })
    };
  
    //this.lawsRef = this.getRef().child('mmlaws');
  }
        ...
        <Content>
          <List
            dataArray={this.state.laws} renderRow={data =>
              <ListItem button onPress={() => { Actions["myanmarview"]({title: data.title, url:data.url, id:data.id}); this.props.closeDrawer() }} >
...
export default connect(mapStateToProps, bindAction)(Myanmar);
